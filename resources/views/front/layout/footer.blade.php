                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-12 col-sm-12">
                            <div class="widget">
                                ...
                                <p class="mb-3">
                                    If you are going to use of Lorem Ipsum need
                                    to be sure there isn't anything hidden of
                                    text
                                </p>
                                <ul class="contact_info">
                                    <li>
                                        ...
                                        <p>
                                            123 Street, Old Trafford, NewYork,
                                            USA
                                        </p>
                                    </li>
                                    <li>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-md-4">
                                        <div class="icon_box icon_box_style2">
                                            <div class="icon">
                                                <i
                                                    class="flaticon-money-back"
                                                ></i>
                                            </div>
                                            <div class="icon_box_content">
                                                <h5>
                                                    2 Day Returns Guarantee
                                                </h5>
                                                <p>
                                                    Phasellus blandit massa enim
                                                    elit of passage varius nunc.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-4">
                            <p class="mb-lg-0 text-center">
                                © 2020 All Rights Reserved by Foodistan
                            </p>
                        </div>
                        <div class="col-lg-4 order-lg-first">
                            <div class="widget mb-lg-0">
                                <ul
                                    class="social_icons text-center text-lg-left"
                                >
                                    <li>
                        ...
                        <div class="col-lg-4">
                            <ul
                                class="footer_payment text-center text-lg-right"
                            >
                                <li>
                                    <a href="#"
                                        ><img
